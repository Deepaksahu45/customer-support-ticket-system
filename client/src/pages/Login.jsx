  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 relative overflow-hidden"
      style={{
        background: `#071a0e`,
        backgroundImage: `
          radial-gradient(circle at 70% 20%, rgba(34,197,94,0.2), transparent 50%),
          radial-gradient(circle at 20% 80%, rgba(34,197,94,0.12), transparent 40%),
          radial-gradient(circle at 50% 50%, rgba(34,197,94,0.05), transparent 60%)
        `,
      }}
    >
      {/* Floating orbs */}
      <div className="absolute top-20 right-20 w-72 h-72 bg-aegis-green/5 rounded-full blur-3xl animate-pulse" />
      <div className="absolute bottom-20 left-20 w-96 h-96 bg-aegis-green/3 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }} />
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex items-center justify-between text-sm">
            <label className="flex items-center gap-2 text-aegis-muted cursor-pointer">
              <input type="checkbox" className="w-4 h-4 rounded border-aegis-border bg-aegis-dark accent-aegis-green" />
              Remember me
            </label>
            <button type="button" className="text-aegis-green hover:text-aegis-green/80 transition-colors">
              Forgot password?
            </button>
          </div>
        ...
        <p className="mt-6 text-center text-sm text-aegis-muted">
          ...
          <Link to="/register" className="text-aegis-green hover:text-aegis-green/80 font-medium transition-colors">
            Create account
          </Link>
        </p>
      </motion.div>
